...
class ToothRoot extends Component {
      ...
      <div id="layers" className="flex flex-col justify-center items-center">
        ...
        >
          <g id="layer-group">
            ...
            <path
              id="path_0"
              d="m126.95,11.15s43.17,74.23,52.58,145.16,2.26,90.32,10.97,90.32,7.42-14.52,9.35-49.03S219.21,11.15,318.89,11.15c91.94,0,114.84,95.48,115.81,148.06.83,44.86-2.26,57.1,5.48,57.1s8.06-4.16,20.65-58.69c12.58-54.53,58.71-146.47,58.71-146.47"
            />
        ...
        {/* <button
          ...
          onClick={() => {
            layerSocket.emit("selectLayer", imgIdx);
            imgIdx += 1;
          }}
  ...
  updateLerpPos() {
    ...
    s.x = lerp(Number(indicator.style.left.split("px")[0]), mousePos.x, 0.01);
    s.y = lerp(Number(indicator.style.top.split("px")[0]), mousePos.y, 0.01);
  ...
  addOnStrokeListener(layerId, color) {
    ...
    svg.addEventListener("mousemove", function (event) {
      ...
      mousePos.x = event.clientX - svgRect.left;
      mousePos.y = event.clientY - svgRect.left;
